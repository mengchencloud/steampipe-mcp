...
import type { DbTool } from "./types.js";
...
// Re-export DbTool type
export type { DbTool } from "./types.js";

// Export all tools for server capabilities
export const tools = {
  steampipe_query: queryTool,
  steampipe_table_list: tableListTool,
  steampipe_table_show: tableShowTool,
  steampipe_plugin_list: pluginListTool,
  steampipe_plugin_show: pluginShowTool,
} as const;
